...
public class Exp1Hander{
    ...
    @GetMapping("/exp1")
    public String exp1(@RequestParam("toEncry") String toEncry, @RequestParam("method") String method) {
        ...
        return encryptedDigest.toLowerCase();
    }
    //mapped to localhost:port/seminar1/exp2
    @GetMapping("/exp2")
    @ResponseBody
    public String[] exp2(@RequestParam("method") String method, @RequestParam("enc") String enc, @RequestParam("iv") String iv,
    ...
    String[] exp32(@RequestParam("enc") String enc) throws NoSuchPaddingException, UnsupportedEncodingException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, InvalidKeySpecException {
        String [] results = new String[2];
    ...
    public String validation (@RequestParam("contents") String contents, @RequestParam("issuer") String issuer,
