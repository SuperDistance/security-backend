 ...
 *@description: reverse code generator for Mybatis Plus
 *@author: Tianshi Chen
 *@create: 2020-04-22 16:43
 */
public class Generator {
        ...
        public void testGenerator(){
            ...
            config.setActiveRecord(true)//开启AR模式
                    .setAuthor("code maker")//设置作者
                    //生成路径(一般都是生成在此项目的src/main/java下面)
                    .setOutputDir("C:\\Users\\92351\\Documents\\GitHub\\security-backend\\src\\main\\java")
            ...
            packageConfig.setParent("com.platform.security")//设置包名的parent
                    .setMapper("mapper")
                    .setService("service")
